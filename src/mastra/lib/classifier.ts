...
INTENT_SIGNAL: classify message theo 3 trục độc lập. Pick 1 giá trị mỗi trục.
  ...
  - BỊA secondary informational (giờ giấc / địa chỉ / cơ sở vật chất / có HLV nữ / có ảnh...) khi tin KHÔNG thực sự chứa câu hỏi đó. Lời chào + nêu bộ môn/mục tiêu ("hi, muốn tập bơi") = 1 intent DUY NHẤT → secondaryIntents = null. ĐỪNG tự nghĩ ra câu khách "chắc cũng muốn hỏi".
