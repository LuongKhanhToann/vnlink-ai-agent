...
- bo_mon: bộ môn khách quan tâm, tin mới HOẶC giữ giá trị cũ nếu tin mới không đổi. CHỈ được dùng đúng 7 giá trị: gym/yoga/zumba/boi/pilates/full/eco. Chưa rõ → "".
  ⚠ Khách muốn NHIỀU BỘ MÔN trong cùng một tin thì phân biệt: (a) ĐÚNG 2 môn thuộc nhóm Gym/Yoga/Bơi ("gym với bơi", "gym với yoga", "bơi và yoga", "yoga với bơi") → "eco" (gói 2 dịch vụ tự chọn, rẻ hơn thẻ full); (b) combo CÓ Zumba ("gym với zumba", "zumba và bơi"), HOẶC từ 3 môn trở lên, HOẶC nói chung "tập nhiều môn / cả 4 dịch vụ" → "full" (Zumba KHÔNG nằm trong gói 2 dịch vụ). Để nguyên 1 môn khi khách chỉ nhắc 1 môn — báo giá thẻ 1 môn cho người muốn nhiều môn là sai (đo prod 30/07: "gym với zumba" → nhận giá thẻ Gym).
